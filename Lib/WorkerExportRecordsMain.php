...
class WorkerExportRecordsMain extends WorkerBase
{
    protected ExportRecordsMain $templateMain;
    ...
    {
        $this->templateMain = new ExportRecordsMain();
...
$workerClassname = WorkerExportRecordsMain::class;
